...
function CursosCell({ row, onOpenCompetencyDetail }) {
  return (
    <button
      type="button"
      onClick={() => onOpenCompetencyDetail(row)}
...
function CompetencyDescriptionCell({ row }) {
  return (
...
function CompetencyActionsCell({
  row,
...
function useCompetencyColumns({
  ...
  return useMemo(
    () => [
      ...
      {
        header: 'Descripción',
        cell: (row) => <CompetencyDescriptionCell row={row} />,
      },
      {
        header: 'Acciones',
        className: 'text-right',
        cell: (row) => (
          <CompetencyActionsCell
            row={row}
            onOpenCompetencyDetail={onOpenCompetencyDetail}
            onOpenCreateSubcomp={onOpenCreateSubcomp}
            onOpenReviewsForCompetency={onOpenReviewsForCompetency}
