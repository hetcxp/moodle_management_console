...
/**
 * Competency repository tests for tool_management_console.
 *
 ...
 * @copyright  2026 Hector Teran
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 * @covers     \tool_management_console\repository\competency_repository
 */
class competency_repository_test extends advanced_testcase {
    ...
    public function test_framework_and_competency_crud_and_batch_queries() {
        ...
        $courses = \tool_management_console\repository\competency_repository::get_competency_courses($compid);
        $this->assertCount(1, $courses);
        $this->assertEquals($course->id, $courses[0]['id']);

        $subcourses = \tool_management_console\repository\competency_repository::get_subcompetencies_courses($compid);
