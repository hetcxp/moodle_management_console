    ...
    public static function get_learning_path_detail_returns() {
        return new external_single_structure([
            ...
            'sections'         => new external_multiple_structure(new external_single_structure([
                ...
                'cm_id'               => new external_value(PARAM_INT, 'Course module ID', VALUE_NULLABLE),
                'subcourse_id'        => new external_value(PARAM_INT, 'Subcourse instance ID', VALUE_NULLABLE),
                'subcourse_course_id' => new external_value(PARAM_INT, 'Child course ID', VALUE_NULLABLE),
                'subcourse_fullname'  => new external_value(PARAM_TEXT, 'Child course fullname', VALUE_NULLABLE),
                'subcourse_shortname' => new external_value(PARAM_TEXT, 'Child course shortname', VALUE_NULLABLE),
                'availability'        => new external_value(PARAM_RAW, 'Availability JSON', VALUE_NULLABLE),
